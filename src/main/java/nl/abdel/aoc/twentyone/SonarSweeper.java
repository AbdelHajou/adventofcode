...
public class SonarSweeper {
    ...
    public int countDepthMeasurementIncrements(final int[] depthMeasurements) {
    ...
    public int countSlidingWindowIncrements(final int[] depthMeasurements, final int windowSize) {
        int leftWindowSum = 0;
